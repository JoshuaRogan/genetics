...
@section('questions')
	@include('help.question-groups.genetic-drift')
@overwrite 
@section('summary')
...
@overwrite
@include('help.macros.learn', ['id'=> 'learn-genetic-drift', 'title'=> 'Unit 2.1 Genetic Drift', 'folder'=> '2_1_drift'])
{{-- /Genetic Drift Section --}}


{{-- Selection Section --}}
@section('questions')
	@include('help.question-groups.selection')
@overwrite 
@section('summary')
...
@overwrite
@include('help.macros.learn', ['id'=> 'learn-selection', 'title'=> 'Unit 2.2 Selection', 'folder'=> '2_2_selection'])
{{-- /Selection Section --}}


{{-- Mutation Section --}}
@section('questions')
	@include('help.question-groups.mutation')
@overwrite 
@section('summary')
...
@overwrite
@include('help.macros.learn', ['id'=> 'learn-mutation', 'title'=> 'Unit 2.3 Mutation', 'folder'=> '2_3_mutation'])
{{-- /Mutation Section --}}

{{-- Migration Section --}}
@section('questions')
	@include('help.question-groups.migration')
@overwrite 
@section('summary')
...
@overwrite
@include('help.macros.learn', ['id'=> 'learn-migration', 'title'=> 'Unit 2.4 Migration', 'folder'=> '2_4_migration'])
{{-- /Migration Section --}}

{{-- Assortative Mating Section --}}
@section('questions')
	@include('help.question-groups.assort-mating')
@overwrite 
@section('summary')
...
@overwrite
@include('help.macros.learn', ['id'=> 'learn-assortative-mating', 'title'=> 'Unit 2.5 Assortative Mating', 'folder'=> '2_5_assortative_mating'])
{{-- /Assortative Mating Section --}}

{{-- Inbreeding Section --}}
@section('questions')
	@include('help.question-groups.inbreeding')
@overwrite 
@section('summary')
...
@overwrite
@include('help.macros.learn', ['id'=> 'learn-inbreeding', 'title'=> 'Unit 2.6 Inbreeding', 'folder'=> '2_6_inbreeding'])
{{-- /Inbreeding Section --}}

{{-- Show all of the slides here  --}}
<div id="slide-all-slides"> 
	<h4> All Slides </h4>
	<p> Below are all of the slides avaiable to download or view online! </p>
	<div class="row slide-downloads"> 
		@include('help.macros.slide-item', ['unit'=>'2.1', 'title'=>'Drift', 'folder'=>'2_1_drift'])
		@include('help.macros.slide-item', ['unit'=>'2.2', 'title'=>'Selection', 'folder'=>'2_2_selection'])
		@include('help.macros.slide-item', ['unit'=>'2.3', 'title'=>'Mutation', 'folder'=>'2_3_mutation'])
		@include('help.macros.slide-item', ['unit'=>'2.4', 'title'=>'Migration', 'folder'=>'2_4_migration'])
		@include('help.macros.slide-item', ['unit'=>'2.5', 'title'=>'Assortative Mating', 'folder'=>'2_5_assortative_mating'])
		@include('help.macros.slide-item', ['unit'=>'2.6', 'title'=>'Inbreeding', 'folder'=>'2_6_inbreeding'])
	</div>
</div>
{{-- /Show all of the slides here  --}}
