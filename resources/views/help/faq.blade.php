...
class question{
    ...
    public static function generate_question_html($question, $answer, $gif = false, $imgur = false){
        if($gif){
...
<div class="container">
    ...
    <div class="panel-group" id="accordion-<?php echo question::$section_num++?>"> 
        ...
        <?php 
        question::generate_question_html("How can I create a graph", "To generate a graph you can simply set the variables you are interested in and click the \"<strong>Generate Graph</strong>\" button. You can then add more lines by clicking the \"<strong>Add Line</strong>\" button or reset the graph by again clicking the \"<strong>Generate Graph</strong>\" button.", '/images/faq/create_graph.gif', "http://i.imgur.com/DDdDLC9.gif"); 
        question::generate_question_html("How can I change the variables", "To change any of the variables you can open up the appropriate section by either clicking the <strong>checkbox</strong> to the left of the section name or the <strong>down arrow</strong>. Once the section is opened you can either move the slider or directly inputing the value by clicking the value itself. ", "/images/faq/input.gif", 'http://i.imgur.com/KMVO51x.gif');
        question::generate_question_html("How can I activate a variable", "The variables automatically activate upon <strong>moving the slider</strong> or <strong>inputing a value</strong>. If the variable is active it will be shown in color and a check will be next to the section name.", "/images/faq/activate.gif", "http://i.imgur.com/XDkBJh6.gif");
        question::generate_question_html("How can I deactivate a variable", "If a variable is active (shown in color), you deactivate it by de-selecting the checkbox to the left of the section you would like to deactivate. Once a value is deselected it will be grayed out.", "/images/faq/activate.gif", "http://i.imgur.com/XDkBJh6.gif");
        ...
        question::generate_question_html("How to move in the the zoomed graph", "Click the directional button on the top right of the graph and click and drag to move along the x axis of the graph.", "/images/faq/zoom_pan.gif", "http://i.imgur.com/Ln5MnIi.gif");
        ...
        question::generate_question_html("How to save the graph", "To save the graph as an jpg/png click the triple dot in the upper left corner of the graph. ",'/images/faq/save_image.gif', "http://i.imgur.com/135lVeP.gif");
        question::generate_question_html("How can I increase the contrast for printing", "To choose a high contrast version for printing and projecting you can click the <i class='fa fa-sun-o'></i> icon. in the upper right hand corner of the variables section.","/images/faq/display.gif",  "http://i.imgur.com/Rywoz9S.gif");
        question::generate_question_html("How can I change the legends", "Legends are automatically created for each line. Only the last run is show. But, you can open any other legend by clicking <strong>[Show Legend]</strong>", "/images/faq/legend.gif", "http://i.imgur.com/LjDVaj8.gif");
        question::generate_question_html("Where can I find more information on the variables", "You can click the small question mark next to each variable to see a short explanation of the variable or click \"[Show Help]\" to open all of the explanations at once.", "/images/faq/helper.gif", "http://i.imgur.com/eqw4Rmb.gif");
        ?>
