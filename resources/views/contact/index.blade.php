...
<div class='container'>
		{!! Form::open(['route' => ['contact.send'], 'id'=>'form-contact']) !!}
					...
					<div class="form-group {{ $errors->has('email') ? 'has-error' : '' }}"> 
						...
						{!! Form::email('email', null, ['class' => 'form-control', 'placeholder' => 'e.g. john.doe@pitt.edu', 'required'=>'required']) !!}
						{!! $errors->first('email', '<span class="help-block">:message</span>')!!}
					</div>

					<div class="form-group {{ $errors->has('email_confirmation') ? 'has-error' : '' }}"> 
						{!! Form::label('email_confirmation', 'Verify Email Address*', ['class' => 'control-label']) !!}
						{!! Form::email('email_confirmation', null, ['class' => 'form-control', 'placeholder' => 'e.g. john.doe@pitt.edu', 'required'=>'required']) !!}
						{!! $errors->first('email_confirmation', '<span class="help-block">:message</span>')!!}
					</div>

					<div class="form-group {{ $errors->has('subject') ? 'has-error' : '' }}"> 
						{!! Form::label('subject', 'Subject*', ['class' => 'control-label']) !!}
						{!! Form::text('subject', null, ['class' => 'form-control', 'placeholder' => 'e.g. Drift Question', 'required'=>'required']) !!}
